...
<LINK href="/static/styles/mona.css" rel="stylesheet" type="text/css"></HEAD>
<BODY>
<P class="boardlist"></P>
<H1>'"$board"'</H1>
<HR>
<P class="livethreads"></P>
<P class="nav"><A href="/$board/list">All threads</A> <A href="#newthread">New thread</A></P>
<HR>
<H2 id="newthread">New Thread</H2>
<FORM action="/'"$board"'/post" method="post">
<P class="newthread"><LABEL for="agnomen">Name: </LABEL><INPUT type="text" name="agnomen"> <LABEL for="inscriptio">E-mail: </LABEL><INPUT type="text" name="inscriptio"> <INPUT type="submit" value="POST"><BR>
<LABEL for="titulus">Headline: </LABEL><BR>
<INPUT type="text" name="titulus" id="titulus" size="78" maxlength="78" value=""><BR>
<LABEL for="epistula">Message: </LABEL><BR>
<TEXTAREA name="epistula" id="epistula" rows="12" cols="77"></TEXTAREA></P><INPUT type="hidden" name="ornamentum" value="3b3738ae1c9295d272cec84ecf7af5c8">
